...
#define ID_SEARCHFIELD    53u
#define ID_CODEFIELD      54u

// --- DARLING SLOT RECORDS (array forms for grown tables; no Panel base,
...
// --- DARLING SCROLLPANEL (viewport + h/v bars + content; successor to
...
#define TYPE_SCROLLPANEL_SINGLETON             (PROJ_DARLING | FORM_SINGLETON | ID_SCROLLPANEL)
...
#define TYPE_FLEX_CONTAINER_SINGLETON            (PROJ_DARLING | FORM_SINGLETON | ID_FLEX_CONTAINER)
...
#define TYPE_SEARCHFIELD_SINGLETON     (PROJ_DARLING | FORM_SINGLETON | ID_SEARCHFIELD)
#define TYPE_CODEFIELD_SINGLETON       (PROJ_DARLING | FORM_SINGLETON | ID_CODEFIELD)
